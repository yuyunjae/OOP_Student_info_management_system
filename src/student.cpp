...
void Student::change_name(string _name){name = _name;}
void Student::change_id(string _id){id = _id;}
void Student::change_birth_year(string _birth_year){birth_year = _birth_year;}
void Student::change_tel(string _tel){tel = _tel;}
void Student::change_department(string _department){department = _department;}
